    ...
    <section id="about" className="about">
      ...
      <div className="card">
        <p>
          ...
          personalities such as Carla Bruni, Vaani Kapoor, Robin Schultz, Winona
          Oak, Amina Khalil, and Kylian Mbappé, elevating their presence across
          various platforms.
        </p>
        <p>
          ...
          that resonate with elegance and creativity. My work extends to iconic
          brands such as Chanel, Maybelline New York, Benefit, Mercedes, Meras,
          Amazon, Ounass, Falcons, BLSSD, Tiffany & Co., Gucci, and Dior, where
          my talent has played a key role in crafting honorable campaigns.
        </p>
        <p>
          From fashion editorials and runway shows to TV commercials and music
          videos, I have developed a keen eye for detail, an ability to adapt to
          various styles, and a passion for enchancing natural beauty. My
